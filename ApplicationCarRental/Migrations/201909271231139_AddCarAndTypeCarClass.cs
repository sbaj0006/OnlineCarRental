namespace ApplicationCarRental.Migrations
{
    ...
    public partial class AddCarAndTypeCarClass : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TypeCars", t => t.TypeId, cascadeDelete: true)
                .Index(t => t.TypeId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cars", "TypeId", "dbo.TypeCars");
